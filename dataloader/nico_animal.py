...
IMAGE_PATH1 = os.path.join(ROOT_PATH, 'NicoNew/animal/images')
SPLIT_PATH = os.path.join(ROOT_PATH, 'NicoNew/animal/split_v2_ood')
...
class NicoAnimal(Dataset):
    ...
    def parse_csv(self, csv_path, setname):
        ...
        for l in tqdm(lines, ncols=64):
            ...
            path = os.path.join(IMAGE_PATH1, name)
            path = path.replace('\\', '/')
