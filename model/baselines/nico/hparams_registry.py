...
def _hparams(algorithm, dataset, random_state):
    ...
    if dataset not in SMALL_IMAGES:
        hparams['lr'] = (3e-5, 10**random_state.uniform(-5, -3.5))
        ...
        hparams['lr'] = (0.001, 10**random_state.uniform(-4.5, -2.5))
    ...
    if algorithm in ['DANN', 'CDANN']:
    ...
    elif algorithm == "IRM" or algorithm == "IRM_adv":
        hparams['irm_lambda'] = (5, 10**random_state.uniform(-1, 5))
        hparams['irm_penalty_anneal_iters'] = (1900, int(10**random_state.uniform(0, 4)))
        ...
        hparams['vrex_lambda'] = (10, 10**random_state.uniform(-1, 5))
        hparams['vrex_penalty_anneal_iters'] = (100, int(10**random_state.uniform(0, 4)))
